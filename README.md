...
### Rules
For the following rules x is some valid string of one or more of the character and y is some valid string of zero or more characters.
1. **xI** → **xIU**
2. **MI** → **Mxx**
3. **xIIIy** → **xUy**
4. **xUUy** → **x**
Any string resulting from applying these rules on the single axiom or a theorem is a valid theorem.
